...
import proj4 from "./assets/proj4.png";
  ...
  return (
    <div className="App">
      <div className="topleft"><h>about:</h><br />
      Creative & computer science student. <br />Born (and currently based) in Auckland, NZ.
                    <br />Here to uplift BIPOC + LGBTQ/SGL communities.</div>

      <div className="topright"><h>projects:</h><br />
      <a href="ilyues.github.io/hambur/">hamburger site</a></div>


      <div className="middle"><h>ISABEL LI</h>
      <br />
      <img src={circle} className="image" alt="illust" /></div>

      <div className="bottomleft"><h>experiences:</h><br />
      freelance designer (2017 - present) <br />
      writer for tearaway magazine (2019 - present) <br />
      designer @ innovative design berkeley (sep 2020 - present)
      </div>

      <div className="bottomright"><h>contact:</h><br />
      <a href="mailto:ilyues@berkeley.edu">ilyues@berkeley.edu</a></div>
    </div>
  );
}   
